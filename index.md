...
">
  ...
  <div style="border: 1px solid #ddd; padding: 12px 24px; background: #fff;">
    <img src="/images/logos/huawei.jpg" style="height: 40px;">
  </div>

  <div style="border: 1px solid #ddd; padding: 12px 24px; background: #fff;">
    <img src="/images/logos/kaiwu.png" style="height: 40px;">
  </div>

  <div style="border: 1px solid #ddd; padding: 12px 24px; background: #fff;">
    <img src="/images/logos/yinwang.png" style="height: 40px;">
  </div>
  ...
  <div style="border: 1px solid #ddd; padding: 12px 24px; background: #fff;">
    <img src="/images/logos/zibianliang.jpeg" style="height: 40px;">
  </div>
