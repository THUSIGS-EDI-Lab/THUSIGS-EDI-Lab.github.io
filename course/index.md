...
# {% include icon.html icon="fas fa-chalkboard-teacher" %}Outreach

## Invited Talks

{% include list.html data="courses" component="post-excerpt" filters="category: invited" %}
...
- *2026.04.22*: 徐哲轩、苑会宁、徐泽来（将门）— [大模型在多智能体任务中的评估、训练与 Scaling](https://mp.weixin.qq.com/s/G-o5TURksIgVZGRsbDfqJw)
...
- *2026.03.10*: 臧宏之（青稞）— [一起聊聊 RLinf-USER：面向现实世界机器人在线策略学习的统一且可扩展系统](https://mp.weixin.qq.com/s/2FjaoeuHsPEnAhVUPLOtVw)
...
- *2025.12.25*: 韦明杰（计算机视觉 life）— [RLinf-VLA 框架技术报告——RL 如何训练 VLA？](https://www.bilibili.com/video/BV1dxBoBLEWf/)
- *2025.12.15*: 张瑞泽、季世龙（深蓝）— [NeurIPS'25 & CoRL'25｜无人机也能打排球吗？来看看清华团队的解决方案](https://mp.weixin.qq.com/s/HvLJCr_PNsY0fsx1vS4CXQ)
- *2025.12.09*: 陈康（深蓝）— [对话 πRL 一作：RLinf 流匹配 VLA 在线强化学习框架！π 系列模型成功率提升至 98%](https://mp.weixin.qq.com/s/UNpmZgqLHOSdKnhMWr1ybg)
- *2025.12.06*: 陈康（青稞）— [从 π0 到 πRL：面向流匹配 VLA 的强化学习后训练框架](https://www.bilibili.com/video/BV1Tt2sBPEix/)
...
- *2025.11.26*: 张同和、高枫（将门创投）— [清华 RLinf 团队：RL 可以为 VLA 带来什么？](https://mp.weixin.qq.com/s/MxxzzzGSk2xORpJqCvgOkQ)
...
- *2025.10.31*: 徐泽来、于超（B站）— [2025 bilibili 超级科学晚全程回顾](https://b23.tv/nUEJHVU)
- *2025.10.28*: 高枫、臧宏之（具身智能之心）— [SFT 还是 RL，VLA 到底应该如何训练？](https://mp.weixin.qq.com/s/DMSuxBon8c9CNaAjU1vZZw)
- *2025.07.18*: 高枫（MSRA）— [What can RL bring to VLA generalization?](https://mp.weixin.qq.com/s/MxxzzzGSk2xORpJqCvgOkQ)

## Other Events

{% include list.html data="courses" component="post-excerpt" filters="category: other" %}
